                    ...
                    <Card className="bg-white border border-gray-200">
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-gray-900">Region Preferences</CardTitle>
                        ...
                        <CardContent>
                            ...
                            <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <p className="text-sm text-gray-600">
                                    Selected Region: <span className="text-gray-900 font-semibold">{REGIONS.find(r => r.code === selectedRegion)?.name}</span>
                                </p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white border border-gray-200">
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div>
                                    <p className="text-gray-900 font-medium mb-1">Refresh Trending Data</p>
                                    <p className="text-sm text-gray-600">
                    ...
                    <Card className="bg-white border border-gray-200">
                        ...
                        <CardContent className="space-y-4">
                            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <h3 className="text-gray-900 font-semibold mb-2">YouTube Trend Analyzer</h3>
